...
class DNSResponse():
    ...
    def __init__(self, srcIp: str, dstIp: str, srcPort: str, dstPort: str, pktid: int, responseName: str, responseType: str, responseClass: str, numResponses: int, responseData: str) -> None:
        self.srcIp = srcIp
        self.dstIp = dstIp
